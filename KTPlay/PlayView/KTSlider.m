...
- (void)setup {
    [self setThumbImage:[UIImage imageNamed:@"MoviePlayer_Slider"] forState:UIControlStateNormal];
    [self setThumbImage:[UIImage imageNamed:@"MoviePlayer_Slider"] forState:UIControlStateSelected];
    [self setThumbImage:[UIImage imageNamed:@"MoviePlayer_Slider"] forState:UIControlStateHighlighted];
}
